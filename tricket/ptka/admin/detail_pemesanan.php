        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Detail <small>Data Pemesanan</small></h3>
              </div>
              <!-- /.card-header -->
              <?php
              ...
              <form method="post" name="frm">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="payment_code" class="form-control" value="<?php echo $datapemesanan["payment_code"];?>" readonly>
                  </div>
