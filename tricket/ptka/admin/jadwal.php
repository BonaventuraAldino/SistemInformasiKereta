        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <a class="btn btn-info float-righ" href="index.php?page=addjadwal">
                        ...
                        foreach ($data as $barisdata) {
                          ...
                          <tr>
                            ...
                            <td class="project-actions text-center">
                              ...
                              <!--Edit Button-->
                              <a class="btn btn-info btn-sm" href="index.php?page=updatejadwal&id_schedule=<?php echo $barisdata["id_schedule"];?>">
                              ...
                              <!--Delete Button-->
                              <a class="btn btn-danger btn-sm" href="index.php?page=deletejadwal&id_schedule=<?php echo $barisdata["id_schedule"];?>">
